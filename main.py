        """
        Json Flattener 9ffcrkf
        ======================
        Data engineering tool to aggregate structured datasets with zero hassle.
...
from pathlib import Path
        ...
        APP_NAME    = "Json Flattener 9ffcrkf"
        APP_VERSION = "1.0.0"
...
def _write_output(rows: list, path: Path, suffix: str) -> None:
    ...
    if suffix == ".csv" and rows:
        ...
        def build_parser() -> argparse.ArgumentParser:
            p = argparse.ArgumentParser(prog=APP_NAME, description="Data engineering tool to aggregate structured datasets with zero hassle.")
